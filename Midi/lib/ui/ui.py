...
class MidiUI:
    ...
    def _create_controls_and_sequencer(self) -> None:
        ...
        self.content_frame.config(height=340)  # Set fixed height (adjust as needed)
        self.content_frame.grid_propagate(False)  # Prevent frame from resizing to fit contents
